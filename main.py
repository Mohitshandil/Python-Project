...
def slider_changed(value):
    # Add your code here or leave it empty if you don't have any functionality yet
    pass
...
# icon
image_icon = PhotoImage(file=r"C:\Users\shand\OneDrive\Desktop\BMI Calculator\images\icon.png")
root.iconphoto(False, image_icon)

# TOP
top = PhotoImage(file=r"C:\Users\shand\OneDrive\Desktop\BMI Calculator\images\top.png")
...
# two boxes
box = PhotoImage(file=r"C:\Users\shand\OneDrive\Desktop\BMI Calculator\images\box.png")
Label(root, image=box).place(x=20, y=100)
Label(root, image=box).place(x=240, y=100)

# scale
scale = PhotoImage(file=r"C:\Users\shand\OneDrive\Desktop\BMI Calculator\images\scale.png")
...
def slider_changed(event):
    ...
    img = (Image.open(r"C:\Users\shand\OneDrive\Desktop\BMI Calculator\images\man.png"))
...
# Slider2
# Add your code for Slider2 here
...
label3 = Label(root,font= "arial 10 bold", bg = "lightblue", fg = "#000")
